  ...
  return (
    <DashboardLayout title="Dashboard">
      ...
      <div className="grid grid-cols-4 gap-4 mb-8">
        ...
        <div className="bg-white border border-gray-100 rounded-xl p-5 text-center">
          <p className="text-2xl font-medium text-gray-900">{applications.filter(a => a.status === "applied").length}</p>
        ...
        <div className="bg-white border border-gray-100 rounded-xl p-5 text-center">
          ...
          <p className="text-xs text-gray-400 mt-1">Interview</p>
        </div>
        <div className="bg-white border border-gray-100 rounded-xl p-5 text-center">
        ...
        {applications.length === 0 ? (
          ...
          <div key={app._id} className="px-5 py-4 flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-400 mt-0.5">{app.job?.location} · {app.job?.salary}</p>
              {app.aiScore && (
