  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm bg-white border border-gray-200 rounded-xl p-8 shadow-sm">
        <h1 className="text-xl font-medium text-gray-900 mb-1">Forgot password</h1>
        <p className="text-xs text-gray-400 mb-6">Enter your email and we'll send you an OTP</p>
