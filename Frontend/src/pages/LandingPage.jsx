    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="flex items-center justify-between px-8 py-4 border-b border-gray-100">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link to="/register">
            <Button className="text-sm bg-gray-900 hover:bg-gray-700 text-white">
              Get started
            </Button>
          </Link>
        </div>
      ...
      {/* Hero */}
     <main>  <section className="flex flex-col items-center justify-center text-center px-4 py-24 max-w-3xl mx-auto">
      ...
      <section className="border-y border-gray-100 py-12">
        <div className="max-w-4xl mx-auto grid grid-cols-3 gap-8 text-center px-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">Candidates hired</p>
          </div>
          <div>
        ...
        <div className="grid grid-cols-3 gap-6">
          <div className="border border-gray-100 rounded-xl p-6">
            ...
            <p className="text-xs text-gray-600 leading-relaxed">
              Our AI scores your resume against job descriptions and gives
          ...
          <div className="border border-gray-100 rounded-xl p-6">
            ...
            <p className="text-xs text-gray-600 leading-relaxed">
              Admins can manage candidates visually — drag and drop across
              Applied, Interview, and Hired stages.
            </p>
          </div>
          ...
          <div className="border border-gray-100 rounded-xl p-6">
            ...
            <p className="text-xs text-gray-600 leading-relaxed">
              Upload your resume once and apply to multiple jobs in seconds.
