...
export default function Apply() {
  ...
  // resume state
  const [useProfileResume, setUseProfileResume] = useState(!!user?.resumeUrl); // default to profile resume if exists
  const [resume, setResume] = useState(null);
  const [resumeUrl, setResumeUrl] = useState(user?.resumeUrl || ""); // pre-fill with profile resume
  ...
  // toggle between profile resume and new upload
      ...
      <div className="max-w-2xl mx-auto px-4 py-12">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            {/* Toggle buttons — only show if user has a profile resume */}
            {user?.resumeUrl && (
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      setResumeUrl(""); // reset url when new file selected
                    }}
